...
const Skill = ({name, x, y}) => {
    return(
        ...
        md:text-sm md:py-1.5 md:px-3 sm:bg-transparent sm:dark:bg-transparent xs:text-dark sm:dark:text-light sm:text-bold
        xs:font-bold'
...
const Skills = () => {
  return (
    <>
        <h2 className='font-bold text-8xl mt-48 mb-4 w-full text-center md:text-6xl md:mt-32'>Skills</h2>
        ...
        <Skill name="Premiere Pro" x="-25vw" y="18vw" />
