  ...
  return (
    ...
    <nav>
     ...
     <nav className='flex items-center justify-center flex-wrap'>
        ...
        <motion.a href="https://www.linkedin.com/in/ojogbomichael" target={"_blank"}
        whileHover={{y:-2}}
        whileTap={{scale:0.9}}
        className='w-6 mx-3'>
            <LinkedInIcon/>
    ...
    <nav className='flex items-center flex-col justify-center'>
     ...
     <nav className='flex items-center justify-center flex-wrap mt-2'>
        ...
        <button
        onClick={() => setMode(mode === "light" ? "dark" : "light")}
        className='ml-3 sm:mx-1 flex items-center justify-center rounded-full p-1 w-6 bg-light dark:bg-dark'
        >
        {
            mode === "dark" ?
            <SunIcon className={"fill-dark"}/>
