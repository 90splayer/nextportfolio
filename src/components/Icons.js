...
export const BehanceIcon = ({ className, ...rest }) => (
  ...
  <path fill="none" d="M0 0h256v256H0z" />
    <path
    fill="#00000" 
    d="M8.228 15.01H6V13h2.261c1.878 0 2.003 2.01-.033 2.01zm6.758-2.677h3.018c-.117-1.715-2.73-1.977-3.018 0zM8.182 9H6v2h2.389c1.673 0 1.937-2-.207-2zM24 5v14a5 5 0 0 1-5 5H5a5 5 0 0 1-5-5V5a5 5 0 0 1 5-5h14a5 5 0 0 1 5 5zM14 8h5V7h-5v1zm-3.552 3.618c1.907-.974 1.837-4.55-1.813-4.604H4v9.978h4.311c4.522 0 4.445-4.534 2.137-5.374zm9.487.602c-.274-1.763-1.528-2.95-3.583-2.95-2.094 0-3.352 1.34-3.352 3.947C13 15.848 14.367 17 16.416 17s3.106-1.135 3.4-2h-2.111c-.736.855-2.893.521-2.767-1.353h5.06c.01-.634-.012-1.089-.063-1.427z" />
  </svg>
)
